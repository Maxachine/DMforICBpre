...
def SelectAndGenerate(params, output_file, TrainorTest):
    CancerType = False
    TMB,Systemic_therapy_history,Albumin,NLR,Age,FCNA,HED,Platelets,HGB,BMI,PFS_Months,OS_Months,new = params
    headers_selection = {
        "TMB": TMB,
        "PDL1_TPS(%)": False,
        "Systemic_therapy_history": Systemic_therapy_history,
        "Albumin": Albumin,
    ...
    sheet_name = f"Chowell_{TrainorTest}"               # 指定的 sheet 名称
