...
from utils import device,loss_fn
import numpy as np
import pdb
...
if __name__ == '__main__':
    score_model = torch.nn.DataParallel(ScoreNet(con_dim=6, input_dim=7))
    ...
    # file_path = 'medicaldata_train5.txt'
    ...
    for epoch in tqdm_epoch:
        ...
        torch.save(score_model.state_dict(), 'edm_ckpt_epoch1500.pth')